...
export default function ShelterCards() {
  ...
  const [shelterCards] = useState([
    { id:"1", image: shelterImage, name: "Lorem Ipsum", text:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor... tovább."},
    { id:"2", image: shelterImage, name: "Lorem Ipsum", text:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor... tovább."},
    { id:"3", image: shelterImage, name: "Lorem Ipsum", text:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor... tovább."}
  ])
